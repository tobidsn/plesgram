...
import com.android.android.app.App;
import com.android.android.constants.Constants;
import com.android.android.util.CustomRequest;
...
public class Profile extends Application implements Constants, Parcelable {
    ...
    private int state, sex, year, month, day, verify, itemsCount, photosCount, videosCount, likesCount, giftsCount, followingsCount, followersCount, allowComments, allowMessages, lastAuthorize, accountType;
